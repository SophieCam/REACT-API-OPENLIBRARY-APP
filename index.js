...
function getBooks1(){
    ...
    .then(response=>{
        for(var i=0; i<5; i++){
            document.getElementById("output1").innerHTML+="<h2>"+"<br>Title: &nbsp"+response.docs[i].title+"</h2>"+"By: &nbsp"+response.docs[i].author_name+"<br><br><img src='https://covers.openlibrary.org/b/isbn/"+response.docs[i].isbn[0]+"-M.jpg'><br><br><hr><br>";  }
    });
}
// function getBooks2(){
